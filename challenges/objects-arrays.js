...
var tyran = {
  name:'tyrannosaurus', diet: 'carnivorous', weight: '7000kg', length: '12m', period: 'Late Cretaceous', roar: function(){
...
const uni = graduates.filter(function(university){
  return university.university.indexOf('Uni')
  !== -1;
});
console.log(uni);
